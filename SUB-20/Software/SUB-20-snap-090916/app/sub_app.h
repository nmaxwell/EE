...
/*
*-------------------------------------------------------------------
* Version: $Id: sub_app.h,v 1.33 2009/08/27 17:31:33 avr32 Exp $
*-------------------------------------------------------------------
*/
...
#define I2C_CMD_CASE            5
    ...
    {
        ' ', "i2c_cfg", "CONFIG",
        "I2C config [f-freq|s-sa<VAL>]0-get",
...
#define SPI_CMD_CASE            12
    ...
    {
        ' ', "gpio", "FUNK,VAL,MASK",
        "GPIO operation <r|w|c>,value,mask",
...
#define FIFO_CMD_CASE           18
    ...
    {
        ' ', "fifo_cfg", "FIFO_CONF",
        "Combination of s-SPI|i-I2C|c-clear",
